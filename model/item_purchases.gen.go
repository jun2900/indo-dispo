...
type ItemPurchase struct {
	...
	ItemPurchasePpn      int32     `gorm:"column:item_purchase_ppn;not null" json:"item_purchase_ppn"`
	ItemPurchaseUnit     string    `gorm:"column:item_purchase_unit;not null" json:"item_purchase_unit"`
}
