...
func newItem(db *gorm.DB, opts ...gen.DOOption) item {
	...
	_item.ItemID = field.NewInt32(tableName, "item_id")
	_item.SupplierID = field.NewInt32(tableName, "supplier_id")
	_item.ItemCode = field.NewString(tableName, "item_code")
	_item.ItemName = field.NewString(tableName, "item_name")
	_item.ItemDescription = field.NewString(tableName, "item_description")
	_item.ItemPurchasePrice = field.NewFloat64(tableName, "item_purchase_price")
	_item.ItemSellPrice = field.NewFloat64(tableName, "item_sell_price")
	_item.ItemUnit = field.NewString(tableName, "item_unit")
...
type item struct {
	...
	ItemPurchasePrice field.Float64
	ItemSellPrice     field.Float64
	ItemUnit          field.String
...
func (i *item) updateTableName(table string) *item {
	...
	i.ItemDescription = field.NewString(table, "item_description")
	i.ItemPurchasePrice = field.NewFloat64(table, "item_purchase_price")
	i.ItemSellPrice = field.NewFloat64(table, "item_sell_price")
	i.ItemUnit = field.NewString(table, "item_unit")
...
func (i *item) fillFieldMap() {
	...
	i.fieldMap["item_description"] = i.ItemDescription
	i.fieldMap["item_purchase_price"] = i.ItemPurchasePrice
	i.fieldMap["item_sell_price"] = i.ItemSellPrice
	i.fieldMap["item_unit"] = i.ItemUnit
}
