...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.RoleID = field.NewInt32(tableName, "role_id")
	_admin.AdminName = field.NewString(tableName, "admin_name")
	_admin.AdminEmail = field.NewString(tableName, "admin_email")
	_admin.AdminPassword = field.NewString(tableName, "admin_password")
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.AdminEmail = field.NewString(table, "admin_email")
	a.AdminPassword = field.NewString(table, "admin_password")
...
func (a *admin) fillFieldMap() {
	...
	a.fieldMap["admin_email"] = a.AdminEmail
	a.fieldMap["admin_password"] = a.AdminPassword
}
